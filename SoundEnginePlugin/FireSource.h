...
private:
    ...
    ////// Hiss
    FireFilter      LowpassFilter;
    FireFilter      HighpassFilter;
    
    ////// Cracking
    bool IsCrackingPlay = false;
    AkInt32 CrackingCount;
    FireFilter Cracking_BandpassFilter;

    ////// Lapping
    FireFilter LappingBandpassFilter;
    FireFilter RemoveDCOffset;

    DbToLinearLookupTable dbToLinear;
};
